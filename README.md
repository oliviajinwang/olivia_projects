...
My personal project to explore the visualization of popular tracks and artists on Spotify between 2009-2025.
* [Project README page](./data_visualization_spotify/README.md)


## My Art Journey

* [Path of Colors](./my_art_journey/README.md)
* [Other Technical Drawings and Paintings](./my_art_journey/Technical.md)


## License

- Code in this repository is licensed under the MIT License: [LICENSE-MIT](LICENSE-MIT)
- Artistic assets (images, paintings, drawings, and other artwork) are licensed under
	the Creative Commons Attribution 4.0 International license (CC BY 4.0):
	[LICENSE-CC-BY-4.0](LICENSE-CC-BY-4.0)

If you need a different Creative Commons variant (for example CC BY-SA or CC BY-NC),
